...
///load 
myApp.onPageInit("12-edit-fitunfit", function(page){
...
myApp.showPreloader("<div style='margin-bottom:-15px'><img src='icon/ic_launcher.png' width='50'></div><p style='color: #047edf; font-size: 12px;  margin: 30px 0 0 ; '>Loading Aplikasi</p>");
    setTimeout(function () { 
		 $.ajax({
     url: ""+useWeb+"/Attendance/editkondisi",
    type: "POST",
	 data:' {"username" : "'+strUsername+'", "kondisi" : "'+valradios+'","note_kondisi" : "'+strpenyakit+'","note_kondisi_lain" : "'+notekon+'"}' , 
    contentType: "application/json",
	headers: {
    "Authorization": "" + strToken
  },
 ...
 myApp.hidePreloader();
    ...
    setTimeout(function () { 
     ...
     url: ""+useWeb+"/Attendance/editkondisi",
    type: "POST",
	 data:' {"username" : "'+strUsername+'", "kondisi" : "'+valradios+'","note_kondisi" : "'+notekon+'","note_kondisi_lain" : ""}' , 
    contentType: "application/json",
	headers: {
    "Authorization": "" + strToken
  },
